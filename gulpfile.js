(function () {
    ...
    gulp.task('pack.view', function () {
        ...
        /** Panel */
        gulp.src('app/components/panel/template/panel.html')
            .pipe(gulp.dest('./public/views'));
        gulp.src('app/components/panel/template/panel-header.html')
            .pipe(gulp.dest('./public/views'));
        gulp.src('app/components/panel/template/panel-body.html')
            .pipe(gulp.dest('./public/views'));
        gulp.src('app/components/panel/template/panel-footer.html')
            .pipe(gulp.dest('./public/views'));
